...
CFLAGS := -Os -fPIC -fno-builtin-printf -nostdinc -nostdlib -nostartfiles -fvisibility=hidden  -DWORDSIZE=64 -D__unix__ -DWITH_STDLIB -I deps/libecc -I deps/libecc/src -I deps/libecc/src/external_deps -I . -I deps/ckb-c-stdlib -I deps/ckb-c-stdlib/libc -I deps/ckb-c-stdlib/molecule -Wall -Werror -Wno-nonnull -Wno-nonnull-compare -Wno-unused-function -g
...
PASSED_R1_CFLAGS := -Os -fPIC -nostdinc -nostdlib -Wno-unused-result -DCKB_DECLARATION_ONLY -DWORDSIZE=64 -D__unix__ -DWITH_STDLIB  -fdata-sections -ffunction-sections -I ../ckb-c-stdlib/libc
